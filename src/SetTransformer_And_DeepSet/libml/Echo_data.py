...
#         num_cineloop_with_only_1_frame = 0
        ...
        for PatientStudy in self.PatientStudy_list:
            ...
            assert os.path.exists(this_PatientStudy_dir), 'every PatientStudy from the studylist should be found in {}'.format(this_PatientStudy_dir)
...
#         print('Inside Echo_data_DS1Like EchoDataset, bag_image shape: {}'.format(bag_image.shape))
