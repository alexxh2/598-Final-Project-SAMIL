...
from src.SetTransformer_And_DeepSet.libml.Echo_data import EchoDataset

from src.SetTransformer_And_DeepSet.libml.utils import save_pickle
from src.SetTransformer_And_DeepSet.libml.utils import train_one_epoch, eval_model
from src.SetTransformer_And_DeepSet.libml.utils import EarlyStopping

from src.SetTransformer_And_DeepSet.libml.ema import ModelEMA
from src.SetTransformer_And_DeepSet.libml.randaugment import RandAugmentMC
...
# parser.add_argument('--FeatureExtractor1', default='pytorch_resnet18_beforeGAP', type=str, help='feature extractor1 backbone to use')
...
parser.add_argument('--early_stopping_warmup', default=800, type=int)
...
def create_model(args):
    ...
    if args.model == 'set_transformer':
        from src.SetTransformer_And_DeepSet.libml.models import SetTransformer
        
        model = SetTransformer(num_outputs, dim_output)
    
    elif args.model == 'deepset':
        from src.SetTransformer_And_DeepSet.libml.models import DeepSet
        model = DeepSet(num_outputs, dim_output)
