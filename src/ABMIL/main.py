...
from src.ABMIL.libml.Echo_data import EchoDataset

from src.ABMIL.libml.utils import save_pickle
from src.ABMIL.libml.utils import train_one_epoch, eval_model
from src.ABMIL.libml.utils import EarlyStopping

from src.ABMIL.libml.models.ema import ModelEMA
from src.ABMIL.libml.randaugment import RandAugmentMC
...
parser.add_argument('--early_stopping_warmup', default=500, type=int)
...
def create_model(args):
    ...
    if args.model == 'gated_attention':
        from src.ABMIL.libml.models.model import GatedAttention
        model = GatedAttention()
    elif args.model == 'attention':
        from src.ABMIL.libml.models.model import Attention
        model = Attention()
    else:
        raise NameError('?')
...
if __name__=='__main__':
    ...
    experiment_name = "{}/Optimizer-{}_LrSchedule-{}_LrCycleEpochs-{}_lr-{}_wd-{}".format(args.model, args.optimizer_type, args.lr_schedule_type, args.lr_cycle_epochs, args.lr, args.wd)
